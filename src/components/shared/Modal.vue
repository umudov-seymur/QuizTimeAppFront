        ...
        >
          ...
          >
            ...
            >
              ...
              <button
                class="inline-flex ml-auto items-center justify-center w-6 h-6 text-gray-400 transition-colors duration-200 rounded dark:hover:text-gray-200 hover: hover:text-gray-700"
                aria-label="close"
                @click="close"
              >
                <svg
